...
class PhoneVerification extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final TextEditingController phoneCtrl = TextEditingController(text: phoneNumber);
    return GetBuilder<ProfileController>(
      builder: (controller) {
        ...
        return Form(
          key: controller.phoneVerificationFormKey,
          child: Scaffold(
            ...
            body: Center(
              child: Padding(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      Image.asset(AssetConst.verification),
                      const SizedBox(
                        height: 10,
                      ),
                      !controller.phoneVisible
                          ? Column(
                              children: [
                                      ...
                                      child: Stack(
                                        children: [
                                          ...
                                          TextFormField(
                                            ...
                                            //   // return null;
                                            //   /*=============================================================*/
                                            //   return (n.length + value!.length) < 11
                                ...
                                TextButton(
                                  onPressed: () async {
                                    logger.i('${controller.country} ${phoneCtrl.text}');
                                    await controller.phoneVerification('${controller.country} ${phoneCtrl.text}');
                                  },
                          ...
                          : Column(
                              children: [
                                Text(
                                  "OTP Sending On this Number ${controller.country} ${phoneCtrl.text}",
                                ...
                                ClipRRect(
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: ElevatedButton(
                                        ...
                                        onPressed: () async {
                                          if (controller.phoneVerificationFormKey.currentState!.validate()) {
                                            await controller.verifyOtp(
                                                codeCtrl.text.trim(), phoneCtrl.text, controller.country);
                                          } else {
                                    ...
                                    child: ElevatedButton(
                                        ...
                                        onPressed: () async {
                                          !controller.timerVisible
                                              ? null
                                              : await controller
                                                  .phoneVerification('${controller.country} ${phoneCtrl.text}');
                                        },
                                        child: Row(
